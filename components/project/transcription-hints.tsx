...
export function TranscriptionHintsEditor({
  ...
  return (
    <StageSection
      ...
      description="Told to the transcriber before it starts. Names it hasn't got context for — libraries, products, people — are what it guesses wrong, and every asset generated afterwards repeats the guess."
      footer={
        <>
        ...
        <Field>
          ...
          <FieldDescription>
            {problem ? (
              ...
              <>
                One per line. Exact spellings you want back — short phrases, not
                sentences.
              </>
            )}
          </FieldDescription>
